...
const Cart: FC = () => {
	...
	return (
		<div className='md:px-20 py-10 m-auto' style={{ maxWidth: 1000 }}>
			<div className='flex text-lg font-bold py-3 border-b'>
				<p className='sm:mx-10 flex-1'>Price</p>
				<p className='sm:mx-10 flex-1'>Product name</p>
				<p className='sm:mx-10 flex-1'>Total count</p>
			</div>
